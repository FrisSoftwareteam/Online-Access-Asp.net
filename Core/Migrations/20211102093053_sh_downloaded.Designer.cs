...
namespace FirstReg.Core.Migrations
{
    ...
    [Migration("20211102093053_sh_downloaded")]
    partial class sh_downloaded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FirstReg.Data.CompletedECertRequest", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("CompletedECertRequests");
                });
            ...
            modelBuilder.Entity("FirstReg.Data.CompletedECertRequest", b =>
                {
                    b.HasOne("FirstReg.Data.ECertRequest", "ECertRequest")
                        .WithOne("CompletedECertRequest")
                        .HasForeignKey("FirstReg.Data.CompletedECertRequest", "Id")
                        .IsRequired();
            ...
            modelBuilder.Entity("FirstReg.Data.ECertRequest", b =>
                {
                    b.Navigation("CompletedECertRequest");
                });
